...
<p align="center">
  ...
  <a href="https://github.com/cyhunblr/PrivateCrossVPN/releases"><img src="https://img.shields.io/badge/release-v1.10.0-blue" alt="Latest Release"></a>
...
```
+---------------------------+-------------------------------------------+
|  PrivateCrossVPN v1.10.0   |  Status & Location                        |
...
When `.githooks/pre-push` is enabled, pushes are blocked if version fields are out of sync.
